	...
	class SelectionBox {
		...
		updateFrustum( startPoint, endPoint ) {
			...
			if ( this.camera.isPerspectiveCamera ) {
				...
				// CJS: 追加コードここから
				_vecTopLeft.set( _tmpPoint.x, _tmpPoint.y, - 1 )
				_vecTopRight.set( endPoint.x, _tmpPoint.y, - 1 );
				_vecDownRight.set( endPoint.x, endPoint.y, - 1 );
				_vecDownLeft.set( _tmpPoint.x, endPoint.y, - 1 );
				// 追加コードここまで
